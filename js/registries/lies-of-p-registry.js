...
const maps = [
    ...
    },
    {
        ...
        markers: [
			{ x:175, y:2873, type: "area", tooltip: "Hotel Krat" },
			{ x:178, y:2261, type: "stargazer", tooltip: "Elysian Boulevard Entrance" },
			{ x:1939, y:1172, type: "stargazer", tooltip: "Inside the House on Elysian Boulevard" },
			{
				x:1892, y:1055,
				type: "npc",
				tooltip: {
			...
			{ x:359, y:2058, type: "consumable", tooltip: "Throwing Cell" },
			{ x:565, y:2056, type: "consumable", tooltip: "Sawtoothed Wheel" },
			{ x:938, y:2025, type: "consumable", tooltip: "Gemini's Emergency Protection" },
			{ x:830, y:1753, type: "consumable", tooltip: "Vivid Ergo Fragment" },
			{ x:807, y:1668, type: "consumable", tooltip: "Dim Ergo Fragment" },
			{ x:1109, y:1687, type: "consumable", tooltip: "Attribute Resistance Ampoule" },
			{ x:1310, y:1567, type: "consumable", tooltip: "Electric Blitz Abrasive" },
			{ x:1302, y:1261, type: "consumable", tooltip: "Sharp Pipe" },
			{ x:1255, y:1155, type: "consumable", tooltip: "Vivid Ergo Fragment" },
			{ x:1032, y:936, type: "consumable", tooltip: "Dim Ergo Fragment" },
			{ x:1187, y:616, type: "consumable", tooltip: "Fable Catalyst" },
			{ x:1802, y:843, type: "consumable", tooltip: "Legion Magazine" },
			{ x:2118, y:948, type: "consumable", tooltip: "Venigni's Urgent Repair Tool" },
			{ x:2170, y:1247, type: "consumable", tooltip: "Sawtoothed Wheel" },
			{ x:2212, y:1499, type: "consumable", tooltip: "Venigni's Emergency Protection" },
			{ x:1735, y:1591, type: "consumable", tooltip: "Dim Ergo Fragment" },
			{ x:1734, y:1769, type: "consumable", tooltip: "Radiant Ergo Fragment" },
			{ x:2117, y:1797, type: "consumable", tooltip: "Radiant Ergo Fragment" },
			{ x:1042, y:2365, type: "defencepart", tooltip: "LADA F150 Frame" },
			{ x:1917, y:1481, type: "defencepart", tooltip: "Workshop Union Standard Insulation Converter" },
			{ x:848, y:1478, type: "material", tooltip: "Hidden Moonstone" },
			{ x:1598, y:1313, type: "material", tooltip: "Hidden Moonstone" },
			{ x:1513, y:1133, type: "material", tooltip: "Star Fragment" },
			{ x:2081, y:1302, type: "material", tooltip: "Hidden Moonstone" },
			{ x:2308, y:1674, type: "material", tooltip: "Star Fragment" },
			{ x:1400, y:1024, type: "collectable", tooltip: "Frozen Man's Letter" },
			{ x:2513, y:1185, type: "collectable", tooltip: "Torn Doodle" },
			{ x:2026, y:1565, type: "collectable", tooltip: "Venigni's Krat Landmark Guide II" },
			{ x:1662, y:1270, type: "amulet", tooltip: "Life Amulet" },
			{ x:2144, y:1644, type: "dimensionalbutterfly", tooltip: "Hidden Moonstone" },
			{ x:513, y:2086, type: "ladder", tooltip: "Knocked down from above."},
			{ x:794, y:2219, type: "ladder" },
			{ x:1095, y:666, type: "ladder" },
			{ x:1074, y:1244, type: "ladder" },
			{ x:1086, y:1463, type: "ladder" },
			{ x:1490, y:633, type: "ladder" },
			{ x:1432, y:676, type: "ladder" },
			{ x:1506, y:857, type: "ladder" },
			{ x:1483, y:959, type: "ladder" },
			{ x:1828, y:1650, type: "ladder" },
			{ x:1984, y:1589, type: "ladder" },
			{ x:2060, y:1607, type: "ladder" },
			{ x:2433, y:1483, type: "ladder" },
			{ x:2520, y:1445, type: "ladder" },
			{ x:2042, y:1073, type: "lift" },
			{ x:807, y:1729, type: "lockeddoor", tooltip: "Opens from the other side."}
		]
	},
