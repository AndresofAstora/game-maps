...
const maps = [
						...
						"Core" ]}},]},
    {
        ...
        markers: [
			{ x:244, y:1300, type: "area", tooltip: "Path of Misery" },
			{ x:1196, y:1347, type: "area", tooltip: "St. Frangelico Cathedral Library" },
			{ x:243, y:951, type: "stargazer", tooltip: "St. Frangelico Cathedral Chapel" },
			{ x:606, y:277, type: "consumable", tooltip: "Vivid Ergo Fragment" },
			{ x:906, y:340, type: "consumable", tooltip: "Cat Dust" },
			{ x:1418, y:491, type: "consumable", tooltip: "Radiant Ergo Fragment" },
			{ x:1232, y:792, type: "consumable", tooltip: "Dim Ergo Fragment" },
			{ x:1326, y:1140, type: "consumable", tooltip: "Legion Magzine" },
			{ x:1335, y:1187, type: "consumable", tooltip: "Vivid Ergo Fragment" },
			{ x:1388, y:1344, type: "consumable", tooltip: "Cat Dust" },
			{ x:1418, y:456, type: "material", tooltip: "Hidden Moonstone" },
			{ x:1621, y:600, type: "material", tooltip: "Legion Plug" },
			{ x:1715, y:309, type: "material", tooltip: "Star Fragment" },
			{ x:1496, y:852, type: "material", tooltip: "Crescent Moonstone" },
			{ x:244, y:558, type: "collectable", tooltip: "Stained Choir Sheet Music" },
			{ x:1087, y:114, type: "collectable", tooltip: "Crafted Cryptic Vessel" },
			{ x:2129, y:1001, type: "amulet", tooltip: "Black Cat's Amulet" },
			{ x:2157, y:1036, type: "costume", tooltip: "Monster Sweeper's Hunting Apparel" },
			{ x:606, y:400, type: "ladder", tooltip: "" },
			{ x:1013, y:327, type: "ladder", tooltip: "" },
			{ x:1409, y:327, type: "ladder", tooltip: "" },
			{ x:1403, y:543, type: "ladder", tooltip: "" },
			{ x:1819, y:543, type: "ladder", tooltip: "" },
			{ x:1886, y:401, type: "ladder", tooltip: "" },
			{ x:1886, y:956, type: "ladder", tooltip: "" },
			{ x:1995, y:888, type: "ladder", tooltip: "" },
			{ x:2083, y:888, type: "ladder", tooltip: "" },
			{ x:1479, y:1087, type: "ladder", tooltip: "" },
			{ x:1349, y:1308, type: "ladder", tooltip: "" },
			{ x:799, y:564, type: "lift", tooltip: "" },
			{ x:1248, y:564, type: "lift", tooltip: "" },
			{ x:1670, y:564, type: "lift", tooltip: "" },
			{ x:1248, y:1098, type: "lift", tooltip: "" },
			{ x:1238, y:1315, type: "tool", tooltip: "Krat Supply Box" },
			{ x:2083, y:1029, type: "lockeddoor", tooltip: "(Trinity Key)" },
			{ x:206, y:675, type: "npc", tooltip: "Giango" }]},
    {
				...
				"Quartz" ]}},]},
    {
        ...
        markers: [
			{ x:2191, y:1960, type: "area", tooltip: "Workshop Union Entrance" },
			{ x:83, y:1426, type: "area", tooltip: "Moonlight Town" },
			{ x:2288, y:1739, type: "stargazer", tooltip: "Workshop Union Entrance" },
        	{ x:3059, y:1300, type: "stargazer", tooltip: "Workshop Union Culvert" },
			{ x:1369, y:1078, type: "stargazer", tooltip: "Venigni Works Control Room" },
			{ x:178, y:1428, type: "stargazer", tooltip: "Center of Venigni Works" },
			{ x:625, y:1475, type: "crackscalling" },
			{ x:2323, y:1680, type: "consumable", tooltip: "Chain" },
			{ x:2471, y:1716, type: "consumable", tooltip: "Dim Ergo Fragment" },
			{ x:2037, y:1599, type: "consumable", tooltip: "Radiant Ergo Fragment" },
			{ x:2183, y:1380, type: "consumable", tooltip: "Sawtoothed Wheel" },
			{ x:2408, y:956, type: "consumable", tooltip: "Vivid Ergo Fragment" },
			{ x:3121, y:1472, type: "consumable", tooltip: "Electric Blitz Abrasive" },
			{ x:3010, y:2006, type: "consumable", tooltip: "Radiant Ergo Fragment" },
			{ x:3637, y:1836, type: "consumable", tooltip: "Vivid Ergo Fragment" },
			{ x:3987, y:1567, type: "consumable", tooltip: "Venigni's Urgent Repair Tool" },
			{ x:2591, y:1564, type: "consumable", tooltip: "Dim Ergo Fragment" },
			{ x:2549, y:1359, type: "consumable", tooltip: "Dim Ergo Chunk" },
			{ x:2895, y:959, type: "consumable", tooltip: "Dim Ergo Fragment" },
			{ x:2632, y:778, type: "consumable", tooltip: "Gemini's Emergency Protection" },
			{ x:3254, y:952, type: "consumable", tooltip: "Radiant Ergo Fragment" },
			{ x:3249, y:671, type: "consumable", tooltip: "Dim Ergo Fragment" },
			{ x:2837, y:546, type: "consumable", tooltip: "Vivid Ergo Fragment" },
			{ x:3378, y:153, type: "consumable", tooltip: "Attribute Purification Ampoule" },
			{ x:3571, y:345, type: "consumable", tooltip: "Saw Blade" },
			{ x:3598, y:649, type: "consumable", tooltip: "Vivid Ergo Fragment" },
			{ x:3710, y:861, type: "consumable", tooltip: "Attribute Resistance Ampoule" },
			{ x:1553, y:1208, type: "consumable", tooltip: "Special Purification Ampoule" },
			...
			{ x:2780, y:1173, type: "material", tooltip: "Hidden Moonstone" },
			{ x:2949, y:758, type: "material", tooltip: "Hidden Moonstone" },
			{ x:3081, y:321, type: "material", tooltip: "Star Fragment" },
			{ x:3768, y:772, type: "material", tooltip: "Quartz" },
			{ x:1200, y:1245, type: "material", tooltip: "Hidden Moonstone" },
			{ x:1198, y:1111, type: "material", tooltip: "Star Fragment" },
			{ x:1039, y:1128, type: "material", tooltip: "Technique Crank" },
			{ x:2169, y:1075, type: "collectable", tooltip: "Factory Manager's Report" },
			{ x:1480, y:1357, type: "collectable", tooltip: "Have you seen this eccentric?!" },
			{ x:1563, y:1357, type: "collectable", tooltip: "Doctor's Confessions" },
			{ x:949, y:826, type: "collectable", tooltip: "Descarte's Note" },
			{ x:2195, y:1525, type: "weapon", tooltip: "Salamander Dagger" },
			{ x:3081, y:543, type: "weapon", tooltip: "Booster Glaive" },
			{ x:2561, y:250, type: "weapon", tooltip: "Fire Axe" },
			{ x:3805, y:763, type: "costume", tooltip: "Blue Blood's Tailcoat" },
			...
			{ x:2920, y:944, type: "ladder" },
			{ x:2715, y:630, type: "ladder" },
			{ x:3250, y:1069, type: "ladder" },
			{ x:1459, y:1226, type: "ladder" },
			{ x:3620, y:810, type: "ladder", tooltip: "Activated from above." },
			{ x:2277, y:1663, type: "lockeddoor", tooltip: "Opens from other side." },
			{ x:2736, y:807, type: "lockeddoor", tooltip: "Opens from other side." },
			{ x:3738, y:713, type: "lockeddoor", tooltip: "(Trinity Key)" },
			{ x:3124, y:443, type: "npc", tooltip: "Red Fox" },
			{ x:3069, y:483, type: "npc", tooltip: { title: "Black Cat", items: [
				"Ripped Venigni's Krat Landmark Guide III" ]}},
			{ x:1358, y:1023, type: "npc", tooltip: { title: "Venigni", items: [
				"Fear" ]}},
			{ x:2730, y:720, type: "boss", tooltip: { title: "Survivor", items: [
				"Survivor's Mask",
				"Survivor's Hunting Apparel",
				"Stalker's Promise" ]}},
			{ x:3098, y:738, type: "boss", tooltip: { title: "Puppet of the Future", items: [
				"Radiant Ergo Chunk",
				"Quartz" ]}},
			{ x:299, y:1428, type: "boss", tooltip: { title: "King's Flame, Fuoco", items: [
				"King's Flame Ergo",
				"Flame Grindstone",
					...
					"Recovery Wishstone",]}},]},
    {
        ...
        markers: [
			{ x:2328, y:1854, type: "area", tooltip: "Krat Central Station" },
			{ x:252, y:2382, type: "area", tooltip: "Hotel Krat (Attacked)" },
        	{ x:1782, y:161, type: "stargazer", tooltip: "Collapsed Street" },
			{ x:958, y:1250, type: "stargazer", tooltip: "Krat Central Station Street" },
			{ x:2860, y:1512, type: "consumable", tooltip: "Resplendant Ergo Fragment" },
			{ x:2252, y:1513, type: "consumable", tooltip: "Radiant Ergo Fragment" },
			{ x:2709, y:1233, type: "consumable", tooltip: "Vivid Ergo Fragment" },
			{ x:2489, y:1100, type: "consumable", tooltip: "Shot Put" },
			{ x:2866, y:707, type: "consumable", tooltip: "Special Purification Ampoule" },
			{ x:2362, y:482, type: "consumable", tooltip: "Vivid Ergo Fragment" },
			{ x:2598, y:264, type: "consumable", tooltip: "Radiant Ergo Fragment" },
			{ x:2500, y:77, type: "consumable", tooltip: "Resplendant Ergo Fragment" },
			{ x:1736, y:1340, type: "consumable", tooltip: "Attribute Resistance Ampoule" },
			{ x:1801, y:1340, type: "consumable", tooltip: "Saw Blade" },
			{ x:1884, y:1308, type: "consumable", tooltip: "Resplendant Ergo Fragment" },
			{ x:1278, y:431, type: "consumable", tooltip: "Fable Catalyst" },
			{ x:1124, y:1308, type: "consumable", tooltip: "Resplendant Ergo Fragment" },
			{ x:1230, y:1233, type: "consumable", tooltip: "Gemini's Iron Protection" },
			{ x:449, y:1416, type: "consumable", tooltip: "Thermite" },
			{ x:566, y:1664, type: "consumable", tooltip: "Dim Ergo Fragment" },
			{ x:2115, y:819, type: "material", tooltip: "Dark Moon Moonstone of the Covenant" },
			{ x:2528, y:529, type: "material", tooltip: "Motivity Crank" },
			{ x:1483, y:1684, type: "material", tooltip: "Half Moonstone" },
			{ x:663, y:1399, type: "material", tooltip: "Half Moonstone" },
			{ x:2689, y:1563, type: "collectable", tooltip: "Lover's Letter" },
			{ x:2133, y:647, type: "collectable", tooltip: "Primer for Workshop Technicians" },
			{ x:1464, y:943, type: "collectable", tooltip: "King of Riddles' Hint" },
			{ x:2254, y:1212, type: "dimensionalbutterfly", tooltip: "Balance Crank" },
			{ x:1531, y:1297, type: "dimensionalbutterfly", tooltip: "Half Moonstone" },
			{ x:2211, y:1021, type: "tool", tooltip: "Special Krat Supply Box" },
			{ x:2576, y:485, type: "defencepart", tooltip: "Arch Extra Heavyweight Frame" },
			{ x:2133, y:878, type: "ladder" },
			{ x:2189, y:416, type: "ladder" },
			{ x:1956, y:416, type: "ladder" },
			{ x:1947, y:565, type: "ladder" },
			{ x:1947, y:825, type: "ladder" },
			{ x:1644, y:990, type: "lift" },
			{ x:77, y:1203, type: "lift" },
			{ x:1945, y:968, type: "boss", tooltip: { title: "Walker of Illusions", items: [
					"Dark Moon Moonstone of the Covenant",
					"Legion Caliber" ]}},
			{ x:286, y:2161, type: "boss", tooltip: { title: "Corrupted Parade Master", items: [
					"Full Moonstone",
					"Quartz" ]}},]},
    {
